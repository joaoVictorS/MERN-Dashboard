  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        ...
        >
          <FormControl>
            <FormHelperText sx={{ fontWeight: 500, margin: '10px 0', fontSize: 16, color: '#11142d' }}>Enter Property</FormHelperText>
          ...
          <Stack direction="row" gap={4} >
            <FormControl sx={{ flex: 1 }}>
              ...
              <Select variant="outlined" color="info" displayEmpty required inputProps={{ 'aria-label': 'Without label' }} defaultValue="aparment" {...register('propertyType', { required: true })} >
